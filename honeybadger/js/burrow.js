...
function renderPanel() {
  ...
  ({ board: boardPanel, tasks: tasksPanel, map: mapPanel,
     bulk: bulkPanel, export: exportPanel }[panel] || boardPanel)(el);
}
...
// Brain dump lives in the app now. It had a second negotiation here — a
// different vocabulary (projects only) and a different outcome from the one
// Chief actually runs, which meant the same gesture did two different things
